...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Auto-Instalador do Zappy Flow (Whaticket), Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar whaticket (Zappy Flow)\n"
  printf "   [1] Atualizar whaticket (Zappy Flow)\n"
  printf "   [2] Deletar Whaticket (Zappy Flow)\n"
  printf "   [3] Bloquear Whaticket (Zappy Flow)\n"
  printf "   [4] Desbloquear Whaticket (Zappy Flow)\n"
  printf "   [5] Alter. dominio Whaticket (Zappy Flow)\n"
  printf "\n"
  read -p "> " option
